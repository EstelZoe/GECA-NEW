                    ...
                    <div className="max-w-[950px] mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-12 items-center">
                            ...
                            <FadeInWhenVisible direction="right">
                                <div className="relative group flex justify-center md:justify-start">
                                    <div
                                        className="block relative group w-[85%] sm:w-[80%] md:w-full h-auto sm:h-[300px] md:h-[380px] mx-auto rounded-3xl overflow-hidden shadow-2xl border-[4px] border-white bg-white transition-all duration-500 group-hover:shadow-[0_0_45px_8px_rgba(220,38,38,0.7)]"
